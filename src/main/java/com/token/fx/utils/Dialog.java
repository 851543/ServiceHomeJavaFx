...
public class Dialog {
    ...
    private static VBox createHeader(Type type){
        ...
        switch (type){
            case INFO:
                ...
                icon = new ImageView(new Image("/styles/img/info.png"));
                break;
            case WARNING:
                color = Color.web("#FC6E51");
                icon = new ImageView(new Image("/styles/img/warning.png"));
                break;
            case ERROR:
                color = Color.web("#ED5565");
                icon = new ImageView(new Image("/styles/img/error.png"));
                break;
            case SUCCESS:
                color = Color.web("#02C852");
                icon = new ImageView(new Image("/styles/img/success.png"));
                break;
        }
    ...
    private static void show(Region region){
        ...
        dialog.setDialogContainer(StageManager.getDecorator().getBackground());
